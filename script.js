...
/* セクション定義（トップページの表示順） */
const SECTIONS = [
  { id: "新着・注目の翻訳本", label: "新着・注目の翻訳本", note: "いま話題の翻訳本や、あらためて読みたい海外小説をピックアップ。", weekly: true },
...
北欧ミステリーというと、社会の暗部、過去の傷、沈んだ空気感が魅力だが、本作はそこに読みやすさもある。重さとテンポのバランスがよく、ミステリーとしての引きも十分。北欧ものを読みたいけれど、あまりに重すぎる作品は少し構えてしまう、という人にもすすめやすい一冊。`,
...

  {
    ...
    purchaseUrl: "https://www.hayakawa-online.co.jp/shop/g/g0005210079/",
...
ジャンルを気にせず、まずは物語に巻き込まれてみてほしい。ゴンクール賞という肩書きに身構えず、純粋に「面白い小説」として楽しめる一作。`,
  ...
  },
  {
    ...
    publisherJa: "東京創元社",
    translator: "冨田ひろみ",
    publicationDateJa: "2024年8月",
    formatJa: "文庫",
    translationStatus: "translated",
    isbnJa: "9784488126117",

    coverJa: "",
    coverJaUrl: "https://www.tsogen.co.jp/img/cover_image_l/12611.jpg",
    coverOriginal: "",
    coverOriginalUrl: "",
    coverAlt: "『極夜の灰』書影",
    purchaseUrl: "https://www.tsogen.co.jp/np/isbn/9784488126117",
